...
The Oracles accordion and Explore matrix oracle metric quote individual route steps for display. Those quotes are not the USD helpers above — see [Oracle Adapter Display](./oracle-adapter-display.md).
