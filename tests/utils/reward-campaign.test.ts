...
import { isCampaignEligibleForAddress, type RewardCampaignEligibility } from '~/entities/reward-campaign'

const USER = '0xAaAa00000000000000000000000000000000aAaA'
const OTHER = '0xBbBb00000000000000000000000000000000bBbB'

const makeCampaign = (overrides: Partial<RewardCampaignEligibility> = {}): RewardCampaignEligibility => ({
  ...overrides,
})
