...
describe('v3 proxy utilities', () => {
  ...
  it('allows only SDK-owned V3 path shapes', () => {
    ...
    expect(isV3ProxyPathAllowed('/v3/curation/vaults')).toBe(true)
    expect(isV3ProxyPathAllowed(`/v3/curation/vaults/1/${VAULT}/labels`)).toBe(true)
    ...
    expect(isV3ProxyPathAllowed('/v3/entities')).toBe(true)
    expect(isV3ProxyPathAllowed('/v3/entities/kpk')).toBe(true)
    expect(isV3ProxyPathAllowed('/v3/entities/kpk/addresses')).toBe(true)
    expect(isV3ProxyPathAllowed('/v3/geo-policies')).toBe(true)
    expect(isV3ProxyPathAllowed('/v3/label-sets/public/versions')).toBe(true)
    expect(isV3ProxyPathAllowed('/v3/liquidations')).toBe(true)
    expect(isV3ProxyPathAllowed('/v3/prices')).toBe(true)
    expect(isV3ProxyPathAllowed('/v3/products')).toBe(true)
    expect(isV3ProxyPathAllowed('/v3/products/1/kpk-securitize')).toBe(true)
  ...
  it('rejects unrelated V3 paths and prefix lookalikes', () => {
    ...
    expect(isV3ProxyPathAllowed(`/v3/curation/vaults/1/${VAULT}/labels/admin`)).toBe(false)
    expect(isV3ProxyPathAllowed('/v3/entities/kpk/addresses/admin')).toBe(false)
    expect(isV3ProxyPathAllowed('/v3/entities/bad.dot')).toBe(false)
    ...
    expect(isV3ProxyPathAllowed('/v3/products/1/bad.dot')).toBe(false)
