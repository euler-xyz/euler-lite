...
import type { PythRefreshSlot } from '../domain/reviewed-execution'
import { pythSelector, type PythPreviewData } from './prepared-plan'
...
export const verifyRefreshedPluginPlan = ({
  ...
  slots: readonly PythRefreshSlot[]
  evidence: readonly PythPreviewData[]
  nowSeconds: number
