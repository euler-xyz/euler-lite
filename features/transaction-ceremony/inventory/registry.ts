/**
 * Frozen Stage A inventory for the reviewed transaction ceremony.
 *
 ...
 * wallet write cannot appear without an explicit ceremony migration decision.
 */
...
export const EAGER_PREPARATION_INVENTORY = [
  ...
  { producer: 'useTxBatch.resimulate', cache: 'whole-cart layers and ceremony preparation cache', identity: ['owner', 'chain', 'ordered intent revisions', 'generation'] },
...
export const WALLET_WRITE_SOURCE_INVENTORY = [
  { source: 'composables/useTransactionCeremony.ts', disposition: 'v2' },
  { source: 'features/transaction-ceremony/adapters/eoa.ts', disposition: 'v2' },
  { source: 'features/transaction-ceremony/adapters/safe.ts', disposition: 'v2' },
