...
import type { FinalizedArtifact, SafeCall } from '../domain/template'
...
export class SafeCeremonyAdapter implements CeremonyTransportAdapter {
  readonly transport = 'safe' as const

  constructor(private readonly client: SafeAdapterClient) {}

  async dispatch(_ceremony: SealedCeremony, artifact: FinalizedArtifact, callbacks: DispatchCallbacks): Promise<DispatchResult> {
