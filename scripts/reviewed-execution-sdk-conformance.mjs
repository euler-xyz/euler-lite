...
if (errors.length) {
  console.error(`Reviewed-execution SDK conformance failed for @eulerxyz/euler-v2-sdk ${sdkManifest.version}:`)
  for (const error of errors) console.error(`- ${error}`)
  process.exit(1)
}

console.log(`Reviewed-execution SDK conformance passed for @eulerxyz/euler-v2-sdk ${sdkManifest.version}.`)
