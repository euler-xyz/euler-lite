export const vaultTypeDescriptions: Record<string, string> = {
  governed: 'Governed vaults have a DAO, curator, or other governor that may control parameters such as interest rates, collateral settings, and loan-to-value ratios. Users should review the governor, market configuration, and risks before supplying or borrowing.',
  ...
  governanceLimited: 'Vaults with limited governance have a governor who may have authority to adjust certain parameters, but there is no active curator monitoring and managing them on an ongoing basis. Depositors should assess risk independently.',
